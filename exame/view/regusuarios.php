...
<!--        <div class="page-header">-->
                <h3><span class="glyphicon glyphicon-edit"></span> Registo de Usuarios</h3>
        ...
        <div class="col-md-10">
            ...
            <div class="row">
               		...
               		<?php 
						...
						}elseif($mensagem=="<center><div class='icon-file'><i class='fa fa-remove' aria-hidden='true'></i> Usuario ja esta registado no Sistema!!!</div></center>"){
...
<!--                <div class="panel panel-success">-->
                  ...
                  <div class="form-group  col-md-8 col-md-offset-2">
                    ...
                    <div class="form-group  col-md-8 col-md-offset-2">
                     ...
                     <div class="form-group  col-md-8 col-md-offset-2">
                        <br>
                        <label for="" class="control-label">Usuario Normal <input type="radio" name="perfil" id="perfil" value="estudante" required></label>
                    </div>
