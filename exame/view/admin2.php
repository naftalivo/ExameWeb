        ...
        <!-----------------------Conteudo------------------------------->
          ...
          <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
              ...
              <div class="col-md-12">
                <form method="post" action="topico.php" data-toggle="validator" role="form">
                <div class="row"> 
                <?php 
					if($mensagem==null){
                  ...
                  <div class="form-group has-feedback col-md-8 col-md-offset-2">
					...
					<input type="radio" name="f_estado" value="Ativo" checked="checked">Ativo<br>
					<input type="radio" name="f_estado" value="Inativo" checked="checked">Inativo<br><br><br><br> 
                  </div>
                      
                  <div class="form-group has-feedback col-md-8 col-md-offset-2">
                    <label for="nome">Titulo do Topico</label>
                    <input type="text" class="form-control" name="titulo" id="titulo" placeholder="topico" required> 
                  </div>
                  ...
                  <div class="form-group has-feedback  col-md-8 col-md-offset-2">
                        ...
                        <input type="Date" class="form-control" name="data" id="" required>
                    </div>
